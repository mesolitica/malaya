...
from .text_functions import pad_sentence_batch, simple_textcleaning, stemmer_str_idx
from . import home

factory = StemmerFactory()
sastrawi = factory.create_stemmer()
stemmer_json = home+'/stemmer-deep.json'
stemmer_graph = home+'/stemmer-frozen-model.pb'
GO = 0
PAD = 1
EOS = 2
UNK = 3
...
class Deep_Stemmer:
    ...
    def stem(self,string):
        ...
        token_strings = string.lower().split()
