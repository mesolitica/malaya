...
tpu = tf.distribute.cluster_resolver.TPUClusterResolver(
    'node-8', zone='europe-west4-a', project='mesolitica-tpu'
)
...
def main(_):
    ...
    gin.parse_config_file(
        'gs://mesolitica-tpu-general/t5-data/pretrained_models_super_tiny_operative_config.gin'
    )
    ...
    model = t5.models.MtfModel(
        model_dir='gs://mesolitica-tpu-general/t5-super-tiny-social-media/',
        tpu=TPU_ADDRESS,
