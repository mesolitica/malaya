...
def main(_):
    ...
    gin.parse_config_file(
        'gs://mesolitica-tpu-general/t5-data/pretrained_models_3x_super_tiny_operative_config.gin'
    )
    ...
    model = t5.models.MtfModel(
        model_dir='gs://mesolitica-tpu-general/t5-3x-super-tiny-social-media/',
        tpu=TPU_ADDRESS,
