...
flags.DEFINE_float(
    'learning_rate', 0.003, 'The initial learning rate for Adam.'
)
...
def model_fn_builder(
    ...
    def model_fn(
        ...
        input_encoder = features['input_encoder']
        input_decoder = features['input_decoder']
        y = features['y']
        ...
        model = seq2seq.Model(bert_config = bert_config)
        _, outputs = model.model(
            {'inputs': input_encoder, 'decoder': input_decoder, 'targets': y},
            is_training,
        )
