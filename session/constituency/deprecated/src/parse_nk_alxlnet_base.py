...
def get_bert(bert_model, bert_do_lower_case):
    ...
    config = XLNetConfig.from_json_file('./src/alxlnet-base/config-old.json')
    tokenizer = XLNetTokenizer.from_pretrained('./src/alxlnet-base', do_lower_case = False)
    model = XLNetModel.from_pretrained('./src/alxlnet-base', config = config)
...
class NKChartParser(nn.Module):
    ...
    def __init__(
        ...
        if hparams.use_chars_lstm:
            ...
            d_bert_annotations = self.bert.d_model
