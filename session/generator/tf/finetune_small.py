...
tpu = tf.distribute.cluster_resolver.TPUClusterResolver(
    'node-2', zone = 'us-central1-b', project = 'mesolitica-cloud'
)
...
def cnn_dataset(split, shuffle_files = False):
    ...
    ds = tf.data.TextLineDataset(
        [
            'gs://mesolitica-public/t5-data/bahasa-generator-0.tsv',
            'gs://mesolitica-public/t5-data/bahasa-generator-1.tsv',
            'gs://mesolitica-public/t5-data/bahasa-generator-2.tsv',
            'gs://mesolitica-public/t5-data/bahasa-generator-3.tsv',
            'gs://mesolitica-public/t5-data/bahasa-generator-4.tsv',
            'gs://mesolitica-public/t5-data/bahasa-generator-5.tsv',
        ]
    )
...
def main(_):
    ...
    BASE_DIR = 'gs://mesolitica-general/t5-small-generator-v1'
