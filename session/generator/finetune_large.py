...
def cnn_dataset(split, shuffle_files = False):
    ...
    ds = tf.data.TextLineDataset(
        [
            'gs://mesolitica-tpu-general/t5-data/bahasa-generator-0.tsv',
            'gs://mesolitica-tpu-general/t5-data/bahasa-generator-1.tsv',
            'gs://mesolitica-tpu-general/t5-data/bahasa-generator-2.tsv',
            'gs://mesolitica-tpu-general/t5-data/bahasa-generator-3.tsv',
            'gs://mesolitica-tpu-general/t5-data/bahasa-generator-4.tsv',
            'gs://mesolitica-tpu-general/t5-data/bahasa-generator-5.tsv',
        ]
    )
...
def main(_):
    ...
    BASE_DIR = 'gs://mesolitica-tpu-general/t5-large-generator'
