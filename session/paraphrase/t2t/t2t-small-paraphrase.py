...
# os.system('rm -rf t2t-paraphrase/train-small')
os.system('mkdir t2t-paraphrase/train-small')
DATA_DIR = os.path.expanduser('t2t-paraphrase/data')
TMP_DIR = os.path.expanduser('t2t-paraphrase/tmp')
TRAIN_DIR = os.path.expanduser('t2t-paraphrase/train-small')
...
hparams.warm_start_from_second = 'small/model.ckpt-500000'
