...
def main():
    ...
    model = T5Diaparser.from_pretrained(
    ...
    def preprocess_function(examples):
        a_texts = [ex['texts'] for ex in examples["translation"]]
        a_arcs = [ex['arcs'] for ex in examples["translation"]]
        a_tags = [ex['tags'] for ex in examples["translation"]]

        X, ARC, Y, INDICES, MASK = [], [], [], [], []

        for k in range(len(a_texts)):
