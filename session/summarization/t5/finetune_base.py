...
def cnn_dataset(split, shuffle_files = False):
    ...
    ds = tf.data.TextLineDataset(
        [
            ...
            'gs://mesolitica-public/t5-data/cnn-summarization-2.tsv',
            'gs://mesolitica-public/t5-data/cnn-summarization-3.tsv',
        ]
    )
...
def multinews_dataset(split, shuffle_files = False):
    ...
    ds = tf.data.TextLineDataset(
        [
            ...
            'gs://mesolitica-public/t5-data/multinews-summarization-2.tsv',
        ]
    )
...
def gigawords_dataset(split, shuffle_files = False):
    ...
    ds = tf.data.TextLineDataset(
        [
            ...
            'gs://mesolitica-public/t5-data/gigawords-summarization-2.tsv',
            'gs://mesolitica-public/t5-data/gigawords-summarization-3.tsv',
            'gs://mesolitica-public/t5-data/gigawords-summarization-4.tsv',
        ]
    )
...
def news_dataset(split, shuffle_files = False):
    ...
    ds = tf.data.TextLineDataset(
        [
            ...
            'gs://mesolitica-public/t5-data/news-title-2.tsv',
            'gs://mesolitica-public/t5-data/news-title-3.tsv',
            'gs://mesolitica-public/t5-data/news-title-4.tsv',
        ]
    )
...
def main(_):
    ...
    BASE_DIR = 'gs://mesolitica-general/t5-base-summary'
    ...
    MODEL_DIR = 'gs://mesolitica-public/t5-base'
